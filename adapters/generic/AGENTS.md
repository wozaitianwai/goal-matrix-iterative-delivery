...
This repository uses Goal Matrix Iterative Delivery. Before implementation, establish initialization type, policy constraints, truth source, active goal, and development flow.
